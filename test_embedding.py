...
def main():
    ...
    extraction_results = verify_watermark_extraction(
        original, watermarked, alpha, beta, mark_path, output_prefix=f"ciao"
    )
    ...
    # =================================================================
    cv2.imwrite(
        "./watermarked_groups_images/crispymcmark_" + image_index + ".bmp", watermarked
    )
    detection_functions = {
